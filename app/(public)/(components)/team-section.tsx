...
const TeamSection = () => {
    return (
        <section id="team-section" className="py-12 bg-gray-50 dark:bg-muted sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold leading-tight text-gray-900 dark:text-white sm:text-4xl xl:text-5xl font-pj">Our Team</h2>
                    <p className="mt-4 text-xl leading-7 text-emerald-500 dark:text-emerald-300 sm:mt-8 font-semibold">Meet the Team behind Connect</p>
                </div>

                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div className="md:p-8 lg:p-14">
                        <UserIcon className="mx-auto text-gray-900 dark:text-gray-100"></UserIcon>
                        <h3 className="mt-12 text-xl font-medium text-gray-900 dark:text-gray-100 font-roboto-mono">Draffor Edwin Elikem</h3>
                        <p className="mt-5 text-base text-gray-600 dark:text-gray-300 font-pj">Team Lead</p>
                    </div>
