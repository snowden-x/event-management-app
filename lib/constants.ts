...
export const TERMS = [
    {
      label: "Definitions",
      contents: [
        '"App" refers to Connect, the campus event management application.',
        '"We," "us," and "our" refer to the creators and administrators of Connect.',
        '"You" and "your" refer to users of the app.',
      ],
    },
    {
      label: "User Accounts",
...
export const PRIVACY_POLICY = [
    {
        label: "Last updated: July 24, 2024",
        description: "We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data and tell you about your privacy rights.",
        contents: [],
    },
    {
        label: "Information We Collect",
        description: "We may collect, use, store and transfer different kinds of personal data about you, including:",
        contents: [
            "Identity Data",
            "Contact Data",
            "Technical Data",
    ...
    {
        label: "Data Security",
        description: "We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed.",
        contents: [],
    },
    {
        label: "Your Legal Rights",
        description: "Under certain circumstances, you have rights under data protection laws in relation to your personal data, including the right to:",
        contents: [
...
export const EVENT_CATEGORIES = [
    ...
    {label: "Technology", value:"cultural event"},
...
export const SCHOOLS = [
    {
        ...
        value: "Kwame Nkrumah University of Science and Technology (KNUST)",
    },
    {
        label: "University of Ghana, Legon", 
        value: "University of Ghana, Legon (UG)",
    },
    {
        label: "University of Health and Allied Sciences, Ho", 
        value: "University of Health and Allied Sciences, Ho (UHAS)",
    },
]
